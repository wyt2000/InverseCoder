...
def generate_one_prompt(problem, code):
    # Fill prompt template with one code snippet.
    instruction = f'''Please give some assertion tests for the following code:
## Problem Statement:
{problem}
## Code Snippet:
{code}
...
def main(
    ...
    for line in input_lines:
        line = eval(line)
        problem = line['instruction']
        code = line['response']
        # code = extract_code(code)
        prompts.append(generate_one_prompt(problem, code))
