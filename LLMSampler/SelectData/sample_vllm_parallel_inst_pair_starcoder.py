...
# tokenizer = AutoTokenizer.from_pretrained('../model/starcoder2-instruct-reproduce')
# print(tokenizer('Yes', return_tensors='pt')['input_ids'])

def get_token_ids(model_path, tokens):
    os.environ["TOKENIZERS_PARALLELISM"] = "false"
    tokenizer = AutoTokenizer.from_pretrained(model_path)
    print(tokenizer(tokens[0], return_tensors='pt')['input_ids'])
    token_ids = {
