...
with jsonlines.open('magicoder_data/starcoderdata_evol_by_wizardcoder_gpt4_instructed_by_wizardcoder_reversed_0306_0314_cleaned_filtered_by_stars.jsonl', mode='w') as writer:
